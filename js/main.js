...
function demoWebCafeUI() {
    ...
    var findDomNode = function () {
        ...
        burgerButton = appNavigation.querySelector('.burgerButton');
    ...
    var addEventButtonBugger = function () {
        burgerButton.addEventListener('click', handleSlideToggle);
    };

    // 버거 버튼에 이벤트 제거하는 함수
    var removeEventButtonBugger = function () {
        burgerButton.removeEventListener('click', handleSlideToggle);
    };
    ...
    var slideIn = function () {
        ...
        // burgerButton 상태 업데이트
        burgerButton.setAttribute('aria-pressed', true);
        burgerButton.setAttribute('aria-label', '메뉴 닫기');
        burgerButton.setAttribute('title', '메뉴 닫기');

        // 열린 상태에서 버거 버튼에 이벤트 연결
        burgerButton.addEventListener('keydown', handleShiftTabburgerButton);
    ...
    var slideOut = function () {
        ...
        // burgerButton 상태 업데이트
        burgerButton.setAttribute('aria-pressed', false);
        burgerButton.setAttribute('aria-label', '메뉴 열기');
        burgerButton.setAttribute('title', '메뉴 열기');
        ...
        if (!e.shiftKey && e.keyCode === 9) {
            ...
            if (!isVisible(subMenu)) {
                ...
                lastSubLink.addEventListener('keydown', function (e) {
                    e.preventDefault();
                    e.keyCode === 9 && burgerButton.focus();
                });
            }
        }
    };
    ...
    var handleShiftTabburgerButton = function (e) {
